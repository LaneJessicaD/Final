...
rond_de_jambe = Dance.create("move" => "Rond De Jambe", "definition" => "Means 'leg circle'.
    ...
    front rond de jambe en dedans.", "picture_url" => "http://media-cache-ak0.pinimg.com/736x/56/11/2b/56112b74219e4dfdbbc27f68de726b4b.jpg",
...
grand_battement = Dance.create("move" => "Grand Battement", "alias_id" => ki.id, "definition" => "Meaning 'beat'.
